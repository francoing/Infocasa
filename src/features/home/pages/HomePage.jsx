...
const NOTICIAS_DATA = {
  1: {
    tag: 'Mercado',
    titulo: 'El mercado inmobiliario argentino crece un 22% en el primer semestre de 2026',
    descripcion: 'Las operaciones de compra-venta aumentaron significativamente, impulsadas por la estabilización económica y la baja de las tasas de interés.',
    fuente: 'Infobae',
    fecha: '21/08/2026',
    texto: [
      'Las operaciones de compra-venta aumentaron significativamente en comparación con el año anterior, impulsadas por la estabilización económica y la baja de las tasas de interés. Los créditos hipotecarios UVA volvieron a ser una opción atractiva para los compradores, con un incremento del 45% en las solicitudes durante los primeros seis meses del año.',
      'Las zonas más beneficiadas fueron la Ciudad de Buenos Aires y el Gran Buenos Aires, donde se registró un aumento del 22% en las transacciones. Los departamentos de 2 y 3 ambientes fueron los más demandados, con precios que oscilan entre los $85.000 y $160.000 USD.'
    ],
    link: 'https://www.infobae.com/economia/2026/08/21/el-mercado-inmobiliario-argentino-crece-un-22-en-el-primer-semestre-de-2026/'
  },
  2: {
    tag: 'Inversión',
    titulo: 'Puerto Madero y Recoleta lideran los barrios más caros para invertir en 2026',
    descripcion: 'Puerto Madero, Recoleta y Palermo Chico lideran el ranking de los barrios porteños con mayor valor del metro cuadrado.',
    fuente: 'El Cronista',
    fecha: '20/08/2026',
    texto: [
      'Puerto Madero, Recoleta y Palermo Chico lideran el ranking de los barrios porteños con mayor valor del metro cuadrado, con precios que superan los $8.200 USD. Estas zonas se mantienen como las favoritas para inversores locales y extranjeros debido a su alta rentabilidad y plusvalía.',
      'En contraste, barrios como La Boca, Barracas y Lugano ofrecen precios más accesibles para quienes buscan invertir a largo plazo con proyección de crecimiento. Se espera que el valor de estas zonas aumente en los próximos años.'
    ],
    link: 'https://www.cronista.com/inmobiliario/puerto-madero-y-recoleta-lideran-los-barrios-mas-caros-para-invertir-en-2026/'
  },
  3: {
    tag: 'Finanzas',
    titulo: 'Nuevas líneas de créditos hipotecarios lanzadas en agosto 2026',
    descripcion: 'Los bancos comenzaron a ofrecer nuevas líneas de financiamiento para la compra de viviendas, con tasas competitivas.',
    fuente: 'La Nación',
    fecha: '19/08/2026',
    texto: [
      'Los bancos comenzaron a ofrecer nuevas líneas de financiamiento para la compra de viviendas, con tasas competitivas que rondan el 6.5% anual. El Banco Nación y el Banco Ciudad son las entidades que lideran la oferta de créditos hipotecarios en el mercado.',
      'Los requisitos se flexibilizaron, permitiendo a más familias acceder a su vivienda propia. Se estima que más de 60.000 familias podrán beneficiarse de estos créditos durante 2026, lo que impulsará el mercado inmobiliario.'
    ],
    link: 'https://www.lanacion.com.ar/propiedades/nuevas-lineas-de-creditos-hipotecarios-lanzadas-en-agosto-2026/'
  },
  4: {
    tag: 'Construcción',
    titulo: 'El sector construcción crece un 28% con más de 15.000 nuevos proyectos',
    descripcion: 'Expertos del sector inmobiliario confirman un aumento en las transacciones durante los primeros ocho meses del año.',
    fuente: 'Ámbito',
    fecha: '18/08/2026',
    texto: [
      'Expertos del sector inmobiliario confirman un aumento en las transacciones durante los primeros ocho meses del año, impulsado por la estabilización macroeconómica y la vuelta de los créditos hipotecarios. Las ventas crecieron un 28% en el segundo trimestre.',
      'Las constructoras ya están planificando nuevos proyectos en zonas estratégicas, especialmente en el interior del país, donde los precios son más competitivos y la demanda crece constantemente.'
    ],
    link: 'https://www.ambito.com/negocios/construccion/el-sector-construccion-crece-un-28-con-mas-de-15000-nuevos-proyectos-2026/'
  },
  5: {
    tag: 'Arquitectura',
    titulo: 'Arquitectura sustentable: el 45% de los nuevos proyectos son eco-friendly',
    descripcion: 'Cada vez más proyectos inmobiliarios apuestan por la eficiencia energética y el diseño eco-friendly.',
    fuente: 'Clarín',
    fecha: '17/08/2026',
    texto: [
      'Cada vez más proyectos inmobiliarios apuestan por la eficiencia energética y el diseño eco-friendly, incorporando paneles solares, techos verdes y sistemas de recolección de agua de lluvia. Estas características no solo reducen el impacto ambiental sino que también generan ahorros significativos en los costos de mantenimiento.',
      'Los compradores valoran cada vez más las certificaciones ambientales, lo que ha llevado a las desarrolladoras a adoptar estos estándares en sus nuevas construcciones. Más del 45% de los proyectos actuales incorporan al menos una de estas características.'
    ],
    link: 'https://www.clarin.com/ciudades/arquitectura-sustentable-el-45-por-ciento-de-los-nuevos-proyectos-son-eco-friendly-2026/'
  },
  6: {
    tag: 'Tendencias',
    titulo: 'Alquileres temporarios: el negocio crece un 35% en 2026',
    descripcion: 'Plataformas como Airbnb impulsan el crecimiento de alquileres por cortos períodos, con un aumento del 35% en las reservas.',
    fuente: 'Infobae',
    fecha: '16/08/2026',
    texto: [
      'Plataformas como Airbnb impulsan el crecimiento de alquileres por cortos períodos, con un aumento del 35% en las reservas durante 2026. Esta modalidad se ha convertido en una alternativa rentable para los propietarios que buscan maximizar el rendimiento de sus inversiones.',
      'Las ciudades más demandadas para este tipo de alquileres son Buenos Aires, Córdoba, Mendoza y Bariloche, que ofrecen una amplia oferta turística y una alta demanda de alojamientos temporarios durante todo el año.'
    ],
    link: 'https://www.infobae.com/propiedades/2026/08/16/alquileres-temporarios-el-negocio-crece-un-35-por-ciento-en-2026/'
  }
};
...
export default function HomePage() {
  ...
  return (
    <Layout>
      <div className="flex flex-col">
        ...
        {/* ===== SECCIÓN DE NOTICIAS (estilo mockup) ===== */}
  ...
  <div className="container">
    <div className="section-header">
      ...
      <p className="noticias-subtitle">Hacé clic en cada noticia para leer el contenido completo - Agosto 2026</p>
    </div>
    
    <div className="noticias-grid">
    {Object.entries(NOTICIAS_DATA).map(([id, noticia]) => (
      <div 
        key={id} 
    ...
    <div className="noticias-ver-mas">
      <Link to="/noticias" className="btn btn-outline">
        ...
        {/* ===== MODAL / POP-UP DE NOTICIA (adaptado del mockup) ===== */}
        {noticiaSeleccionada && (
          <div 
          ...
          >
            ...
            <div className="noticia-modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="noticia-modal-body">
                <span className="noticia-tag">{NOTICIAS_DATA[noticiaSeleccionada].tag}</span>
                <h2>{NOTICIAS_DATA[noticiaSeleccionada].titulo}</h2>
                <div className="modal-meta">
                  <span className="modal-fuente">{NOTICIAS_DATA[noticiaSeleccionada].fuente}</span>
                  <span>{NOTICIAS_DATA[noticiaSeleccionada].fecha}</span>
                </div>
                <div className="modal-texto">
                  {NOTICIAS_DATA[noticiaSeleccionada].texto.map((parrafo, index) => (
                    <p key={index}>{parrafo}</p>
                  ))}
                  <a 
                    href={NOTICIAS_DATA[noticiaSeleccionada].link} 
                    target="_blank" 
