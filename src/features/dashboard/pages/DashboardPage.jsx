...
import { Home, MessageSquare, Plus, Edit, Trash2, ExternalLink, Loader2, MapPin, Calendar, TrendingDown, Percent, ChevronDown, ChevronUp, Eye, Heart, Send, Search, Check, QrCode } from "lucide-react";
...
import QrModal from "@/features/dashboard/components/QrModal";
...
export default function DashboardPage() {
  ...
  const openQrModal = (property) => {
  setQrProperty(property);
  setQrModalOpen(true);
};
                      ...
                      <div key={prop.id} className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        <div className="p-4 flex flex-col md:flex-row items-center gap-6">
                          ...
                          <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                            ...
                            {/* BOTÓN QR (SOLO VENDEDORES) */}
                              <button
                                onClick={() => openQrModal(prop)}
